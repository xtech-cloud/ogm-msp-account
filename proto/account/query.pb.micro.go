...
func (c *queryService) List(ctx context.Context, in *QueryListRequest, opts ...client.CallOption) (*QueryListResponse, error) {
	req := c.c.NewRequest(c.name, "Query.List", in)
